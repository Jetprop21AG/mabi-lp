...
import { XCircle, CheckCircle2, Clock, Database, Server } from "lucide-react";

export function CompetitorComparison() {
  const t = useTranslations("CompetitorComparison");
    ...
    <div className="mt-32">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        >
          ...
          <p className="text-gray-400 text-sm mb-8">{t("whyNotSapDesc")}</p>
          
          <div className="space-y-6">
            <div>
              <div className="flex justify-between text-sm mb-2">
                <span className="text-gray-400 flex items-center gap-1"><Clock size={14}/> {t("deploymentTime")}</span>
              </div>
              <div className="space-y-3">
                <div>
                  <div className="flex justify-between text-xs mb-1">
                    <span className="text-red-400">SAP B1</span>
                    <span className="text-gray-500">{t("sapTime")}</span>
                  </div>
                ...
                <div>
                  <div className="flex justify-between text-xs mb-1">
                    ...
                    <span className="text-blue-400">{t("mabiTime")}</span>
                  </div>
                  <div className="h-2 bg-white/5 rounded-full overflow-hidden">
            ...
            <div className="pt-4 border-t border-white/5">
              <ul className="space-y-3 text-sm">
                <li className="flex gap-2 items-start text-gray-300">
                  ...
                  <span>{t("unpredictableCosts")}</span>
                </li>
                <li className="flex gap-2 items-start text-gray-300">
                  <CheckCircle2 size={16} className="text-green-500 shrink-0 mt-0.5" />
                  <span>{t("mabiFixed")}</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        >
          ...
          <p className="text-gray-400 text-sm mb-8">{t("whyNotComarchDesc")}</p>
          
          <div className="space-y-6">
             <div>
              <div className="flex justify-between text-sm mb-4">
                <span className="text-gray-400 flex items-center gap-1"><Server size={14}/> {t("architecture")}</span>
              </div>
              <div className="grid grid-cols-2 gap-4">
                 <div className="bg-white/5 rounded-lg p-3 text-center border border-orange-500/20">
                    ...
                    <div className="text-sm font-bold text-orange-400">{t("fatClient")}</div>
                    <div className="text-[10px] text-gray-500 mt-1">{t("windowsOnly")}</div>
                 </div>
                 <div className="bg-blue-900/20 rounded-lg p-3 text-center border border-blue-500/30">
                    ...
                    <div className="text-sm font-bold text-blue-400">{t("cloudNative")}</div>
                    <div className="text-[10px] text-blue-300/70 mt-1">{t("browserPwa")}</div>
                 </div>
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-white/5">
              <ul className="space-y-3 text-sm">
                <li className="flex gap-2 items-start text-gray-300">
                  ...
                  <span>{t("expensiveUpdates")}</span>
                </li>
                <li className="flex gap-2 items-start text-gray-300">
                  <CheckCircle2 size={16} className="text-green-500 shrink-0 mt-0.5" />
                  <span>{t("mabiUpdates")}</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        >
          ...
          <h4 className="text-xl font-bold mb-6 flex items-center gap-2">
            ...
            {t("whyNotFrankenstein")}
          </h4>
          <p className="text-gray-400 text-sm mb-8">{t("whyNotFrankensteinDesc")}</p>

          <div className="space-y-6">
             <div>
              <div className="flex justify-between text-sm mb-4">
                <span className="text-gray-400 flex items-center gap-1"><Database size={14}/> {t("dataFlow")}</span>
              </div>
              <div className="relative h-20 bg-white/5 rounded-lg border border-white/10 flex items-center justify-between px-4 mb-4">
                 ...
                 <div className="flex-1 flex flex-col items-center justify-center px-2">
                    <div className="w-full h-px border-t border-dashed border-red-500 relative">
                        <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#111] px-1 text-[10px] text-red-400">{t("apiErrors")}</span>
                    </div>
                 </div>
              ...
              <div className="relative h-12 bg-blue-900/20 rounded-lg border border-blue-500/30 flex items-center justify-center">
                 <span className="text-sm font-bold text-blue-400">{t("singleSource")}</span>
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-white/5">
              <ul className="space-y-3 text-sm">
                <li className="flex gap-2 items-start text-gray-300">
                  ...
                  <span>{t("scatteredResponsibility")}</span>
                </li>
                <li className="flex gap-2 items-start text-gray-300">
                  <CheckCircle2 size={16} className="text-green-500 shrink-0 mt-0.5" />
                  <span>{t("oneEcosystem")}</span>
                </li>
              </ul>
            </div>
          </div>
