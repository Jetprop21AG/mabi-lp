        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/2">
             ...
             <h2 className="text-4xl md:text-5xl font-bold mb-6">
               Sprawdź budżet <span className="text-green-500">ZANIM</span> wydasz.
             </h2>
             <p className="text-xl text-gray-400 mb-8 leading-relaxed">
               Tradycyjnie dowiadujesz się o przekroczeniu budżetu po fakcie, gdy przychodzi faktura.
               W MABI system sprawdza dostępność środków w momencie zapotrzebowania.
             </p>
             ...
             <ul className="space-y-4 mb-8">
               <li className="flex items-start gap-3">
                 ...
                 <div>
                   <h4 className="font-bold text-white">Budżety miesięczne/kwartalne</h4>
                   <p className="text-sm text-gray-400">Elastyczne planowanie per dział lub projekt.</p>
                 </div>
               </li>
               <li className="flex items-start gap-3">
                 <CheckCircle2 className="text-green-500 shrink-0 mt-1" />
                 <div>
                   <h4 className="font-bold text-white">Rollover niewykorzystanych środków</h4>
                   <p className="text-sm text-gray-400">Premia za oszczędność? Tak, to działa motywująco.</p>
                 </div>
               </li>
               <li className="flex items-start gap-3">
                 <CheckCircle2 className="text-green-500 shrink-0 mt-1" />
                 <div>
                   <h4 className="font-bold text-white">Progi zatwierdzania</h4>
                   <p className="text-sm text-gray-400">Do 500 zł akceptuje kierownik, powyżej dyrektor.</p>
                 </div>
               </li>
             </ul>
          </div>
          ...
          <div className="md:w-1/2 relative">
             ...
             <div className="bg-[#111] border border-white/10 rounded-2xl p-6 shadow-2xl relative">
                <div className="absolute -top-4 -right-4 bg-red-500/10 border border-red-500/20 text-red-400 px-4 py-2 rounded-lg text-sm font-bold flex items-center gap-2 transform rotate-6">
                   <FileX size={16} /> Bez MABI: "Ojej, przekroczyliśmy"
                </div>
                ...
                <div className="space-y-6">
                   <div className="flex items-center gap-4 p-4 bg-white/5 rounded-xl border-l-4 border-blue-500">
                      ...
                      <div>
                         <h4 className="text-white font-medium">Zapotrzebowanie</h4>
                         <p className="text-xs text-gray-400">Jan Kowalski: Nowy laptop (4500 zł)</p>
                      </div>
                   </div>
                   ...
                   <div className="flex items-center gap-4 p-4 bg-green-900/10 rounded-xl border border-green-500/20">
                      ...
                      <div>
                         <h4 className="text-green-400 font-medium">Budżet IT: Dostępny</h4>
                         <p className="text-xs text-green-500/60">Pozostało: 12 400 zł</p>
                      </div>
                   </div>
                   ...
                   <div className="flex items-center gap-4 p-4 bg-white/5 rounded-xl border-l-4 border-yellow-500">
                      ...
                      <div>
                         <h4 className="text-white font-medium">Akceptacja Kierownika</h4>
                         <div className="flex gap-2 mt-2">
                            <button className="px-3 py-1 bg-green-600 rounded text-xs text-white font-bold">Zatwierdź</button>
                            <button className="px-3 py-1 bg-red-600/50 rounded text-xs text-white/50">Odrzuć</button>
                         </div>
                      </div>
                   </div>
                </div>
