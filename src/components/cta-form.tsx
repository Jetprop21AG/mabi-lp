      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto bg-[#111] border border-white/10 rounded-3xl p-8 md:p-16 text-center shadow-2xl relative overflow-hidden">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Gotowy na inteligentny biznes?
          </h2>
          <p className="text-xl text-gray-400 mb-12">
            Umów się na demo i zobacz, jak agenci AI mogą usprawnić Twoją produkcję.
          </p>
          ...
          {success ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4 max-w-md mx-auto">
              ...
              >
                {loading ? <Loader2 className="animate-spin" /> : <>Umów demo <ArrowRight /></>}
              </button>
            </form>
          )}
          
          <div className="mt-12 pt-8 border-t border-white/10 text-gray-500 text-sm">
             lub napisz: <a href="mailto:kontakt@mabi.pl" className="text-white hover:underline">kontakt@mabi.pl</a> | +48 XXX XXX XXX
          </div>
        </div>
      </div>
    </section>
