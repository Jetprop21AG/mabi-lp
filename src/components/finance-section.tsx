...
export function FinanceSection() {
  const t = useTranslations("FinanceSection");
  const features = [t("feature0"), t("feature1"), t("feature2"), t("feature3"), t("feature4"), t("feature5"), t("feature6")];
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
           <div className="lg:w-1/2">
              ...
              <div className="mt-12 pt-8 border-t border-white/10 flex flex-wrap gap-6 text-sm text-gray-500">
                 <span className="flex items-center gap-2"><TrendingUp size={16} /> {t("balancePl")}</span>
                 <span className="flex items-center gap-2"><DollarSign size={16} /> {t("cashFlow")}</span>
                 <span className="flex items-center gap-2"><ShieldCheck size={16} /> {t("budgetControl")}</span>
              </div>
           </div>
           ...
           <div className="lg:w-1/2 relative">
              ...
              <div className="relative bg-[#111] border border-white/10 rounded-2xl p-8 shadow-2xl">
                 ...
                 <div className="relative z-10 space-y-6">
                    <h3 className="text-lg font-bold text-white mb-4 text-center">{t("threeWayTitle")}</h3>
                    
                    <div className="flex justify-between items-center gap-4">
                       <div className="bg-blue-900/20 border border-blue-500/30 p-4 rounded-xl text-center flex-1">
                          <div className="text-xs text-blue-400 font-bold mb-1">{t("order")}</div>
                       ...
                       <div className="bg-yellow-900/20 border border-yellow-500/30 p-4 rounded-xl text-center flex-1">
                          <div className="text-xs text-yellow-400 font-bold mb-1">{t("delivery")}</div>
                       ...
                       <div className="bg-green-900/20 border border-green-500/30 p-4 rounded-xl text-center flex-1">
                          <div className="text-xs text-green-400 font-bold mb-1">{t("invoice")}</div>
